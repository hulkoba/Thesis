...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, function, return, null, switch, const, let, if, in, else, case, break},
...
\lstset{
   ...
   basicstyle=\color{CarnationPink}\small,
   keywordstyle=\color{Cerulean}\bfseries\ttfamily,
