...
\end{longtable}
%
Es ist deutlich zu erkennen, dass überall dort wo ein Kontakt bearbeitet wird, die Redux Offline \gls{App} die Erwartungen nicht erfüllt. Im folgenden \hyperref[chap:auswertung]{Abschnitt} werden die Testergebnisse ausgewertet.