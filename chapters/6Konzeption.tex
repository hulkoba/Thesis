...
Zeile 7: Kontakt löschen -- API Erlären \todo{put statt remove!}
% Die Anwort sieht so aus wie im Listing \ref{code:pouchdoc}.
% \begin{center}
%   \lstinputlisting[language=JSON,
%   firstline=45,lastline=60,
%   numbers=left,xleftmargin=20pt,framexleftmargin=15pt,
%   caption={Gespeicherter Kontakt in einer PouchDB}, 
%   label=code:pouchdoc]{code/Pouch.js}
% \end{center}
%
% Sync
%
