...
Es muss also bei der Wahl einer Technologie zur Erstellung einer offlinefähigen Anwendung darauf geachtet werden, dass diese Technologie eine Datenbanklösung bereitstellt, die sich dieser Problematik widmet und sie erfolgreich löst.\\\\
%
%
%
