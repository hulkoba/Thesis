...
% 
  ...
  \midrule
    %
  \multicolumn{1}{l}{\cellcolor[HTML]{cffcc2}\textbf{F6}} &
  \multicolumn{1}{p{0.95\textwidth}}
  ...
  \midrule
  %
  \multicolumn{1}{l}{\cellcolor[HTML]{cffcc2}\textbf{F7}} &
  \multicolumn{1}{p{0.95\textwidth}}
