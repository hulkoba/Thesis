...
\begin{enumerate}
  ...
  \item
\end{enumerate}
% Die Identifizierung des Datensatzes ist für die Kommunikation zwischen Client und Server obligatorisch. \todo{2 unterschiedliche IDs (natural key, UUID) erklären?}\\
