...
Anders als native \glspl{App} werden Webanwendungen nicht auf dem Gerät installiert, sondern in der Regel über einen Webbrowser genutzt.
...
%
% Cache Service Worker App Cache
%
