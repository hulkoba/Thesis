...
Die in \autoref{chap:szenarien} erarbeiteten Szenarien zeigen auf, dass das es immer zu Konflikten kommen kann wenn die Internetverbindung abbricht.
Deswegen werden Konflikte erstellt indem die Verbindung zum Netzwerk unterbrochen wird.\\
Die zu entwickelnden Prototypen müssen auf mindestens zwei Geräten funktionieren und es muss die Möglichkeit bestehen den die Verbindung zum Internet und zum Server zu unterbrechen.
