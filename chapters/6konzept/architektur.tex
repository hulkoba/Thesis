...
Die Komponente hat einen internen State in dem sowohl die Kontaktliste, als auch die Daten für das Formular gespeichert sind. Im Diagramm ist der Status an der blauen Schrift zu erkennen.
...
Die \tt{Contacts}--Komponente fungiert als Model.
Sie handhabt die Daten, die in den Viewkomponenten angezeigt werden und speichert sie in PouchDB.
